...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://radtabs-api.herokuapp.com',
...
var tabEvents = __webpack_require__(15);
...
var getTabs = function getTabs() {
  api.getTabs().then(ui.getTabsSuccess).catch(ui.failure);
};

var onGetTabs = function onGetTabs(event) {
  event.preventDefault();
  getTabs();
};

var onClearTabs = function onClearTabs(event) {
  event.preventDefault();
  ui.clearTabs();
};

var onNewTab = function onNewTab(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.newTab(data).then(ui.newTabSuccess(data)).then(getTabs).catch(ui.failure);
};

var saveTab = function saveTab(event) {
...
var fillField = function fillField() {
...
var onUpdateTab = function onUpdateTab(event) {
  // On clicking submit button after updating tab…
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateTab(data, store.tab.tab_id).then(ui.updateTabSuccess).then(getTabs).catch(ui.failure);
};

var onDeleteTab = function onDeleteTab(event) {
  event.preventDefault();
  api.deleteTab(store.tab.tab_id).then(ui.deleteTabSuccess).then(function () {
    return onGetTabs(event);
  }).catch(ui.failure);
};

var addTabHandlers = function addTabHandlers() {
  $('.tab-return-content').on('click', saveTab).on('mouseover', '.info-td', function (event) {
    $(undefined).css('cursor', 'pointer');
  });
  $('#showHideTabsButton').click(function (event) {
...
var newTab = function newTab(data) {
  return $.ajax({
    url: config.apiUrl + '/tabs',
    method: 'POST',
    data: data,
...
var updateTab = function updateTab(data, tabId) {
  return $.ajax({
...
var deleteTab = function deleteTab(tabId) {
  return $.ajax({
    url: config.apiUrl + '/tabs/' + tabId,
    method: 'DELETE',
    headers: {
...
var showTabsTemplate = __webpack_require__(18);

var getTabsSuccess = function getTabsSuccess(data) {
  var showTabsHtml = showTabsTemplate({ tabs: data.tabs });
  $('.info-section').show();
  $('.tab-return-content').html(showTabsHtml);
};

var clearTabs = function clearTabs() {
  $('.tab-return-content').empty();
  $('.info-section').hide();
};

var newTabSuccess = function newTabSuccess(data) {
...
var successfulModification = function successfulModification() {
  store.successMessageColor();
...
var updateTabSuccess = function updateTabSuccess(data) {
  $('#modalTitleModifyTab').text('Tab updated');
  successfulModification();
};

var deleteTabSuccess = function deleteTabSuccess(data) {
...
module.exports = {
  newTabSuccess: newTabSuccess,
  updateTabSuccess: updateTabSuccess,
  deleteTabSuccess: deleteTabSuccess,
  getTabsSuccess: getTabsSuccess,
  clearTabs: clearTabs,
  failure: failure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  "
    ...
    + "\n  <!-- "
    + ((stack1 = container.invokePartial(__webpack_require__(35),depth0,{"name":"partial","data":data,"blockParams":blockParams,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + " -->\n\n  <tr data-id=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"\n    data-date=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "\"\n    data-project_name=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.project_name : stack1), depth0))
    + "\"\n    data-task=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.task : stack1), depth0))
    + "\"\n    data-time_spent=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.time_spent : stack1), depth0))
    + "\"\n    data-notes=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
    + "\"\n    data-toggle=\"modal\" data-target=\"#modifyTabModal\">\n    <td class=\"date-td\">\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.date : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <td class=\"project-name-td\">\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.project_name : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <td class=\"task-td\">\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.task : stack1),{"name":"if","hash":{},"fn":container.program(8, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <td class=\"time-spent-td\">\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.time_spent : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <td class=\"notes-td\">\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1),{"name":"if","hash":{},"fn":container.program(12, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <td class=\"modify-tab-button-td\"><div class=\"modify-tab-button\" id=\"modify-tab-button\">Modify</div></td>\n  </tr>\n\n";
  ...
  return "        "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.project_name : stack1), depth0))
    + "\n";
},"8":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "        "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.task : stack1), depth0))
    + "\n";
},"10":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "        "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.time_spent : stack1), depth0))
    + "\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.tabs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<br>I'm a partial that is included every <big><i>tabs</i></big> iteration\n";
},"useData":true});
